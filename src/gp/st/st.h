...
/*! @defgroup st Strongly Typed Genetic Programming framework
@ingroup gp
*/
...
@file src/gp/st/st.h
@ingroup st
@brief Main include file for genetiK::gp::st namespace

This file groups all header files of elements of genetiK Strongly Typed GP module

*/

#ifndef GENETIK_GP_ST_H
#define GENETIK_GP_ST_H
