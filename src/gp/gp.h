...
/*! @defgroup gp Genetic Programming framework
@ingroup genetiK
*/
...
@file src/gp/gp.h
@ingroup gp
@brief Main include file for genetiK::gp namespace

This file groups all header files of elements of genetiK GP module
