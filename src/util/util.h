...
@ingroup util
@brief Main include file for utility classes

This file groups all header files of common utility classes, include it to access all the interfaces included in this namespace.

*/

#ifndef GENETIK_UTIL_H
#define GENETIK_UTIL_H
