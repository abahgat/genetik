...
#ifndef GENETIKEX_STRONGLYTYPEDGENETICPROGRAMMING
#define GENETIKEX_STRONGLYTYPEDGENETICPROGRAMMING


namespace genetiKEx{

class StronglyTypedGeneticProgramming
{
	protected:
	public:
		StronglyTypedGeneticProgramming();
		~StronglyTypedGeneticProgramming();
